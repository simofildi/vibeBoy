...
<p align="center">
  <a href="https://marketplace.visualstudio.com/items?itemName=simonefildi.vibeboy">
    <img src="https://img.shields.io/visual-studio-marketplace/v/simonefildi.vibeboy?color=blue&label=vibeBoy" alt="VS Code Marketplace Version">
  </a>
  <a href="https://marketplace.visualstudio.com/items?itemName=simonefildi.vibeboy">
    <img src="https://img.shields.io/visual-studio-marketplace/d/simonefildi.vibeboy?color=blue&label=Downloads" alt="VS Code Marketplace Downloads">
  </a>
...
3. Search for `vibeBoy` and click **Install**. 
   - *Alternatively, you can install directly from the [VS Code Marketplace](https://marketplace.visualstudio.com/items?itemName=simonefildi.vibeboy).*

**Option 2: Manual Installation (.vsix)**
1. Download the latest `.vsix` file from the [Releases](https://github.com/simonefildi/vibeboy/releases) section of this repository.
